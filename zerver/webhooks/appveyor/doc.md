...
1. Select **Add notification**, and then select **Webhook**.

1. Set **Webhook URL** to the URL generated above.

1. Select the events you'd like to be notified about, and click
   **Save**.
